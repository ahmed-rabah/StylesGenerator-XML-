...
export default function Main() {
    ...
    function tagAlreadyExistsAlert() {
        return <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hover:scale-110 w-8/12 bg-orange-400 rounded-lg p-2 flex items-center justify-starts gap-2 text-white font-rubik text-xl `}>
