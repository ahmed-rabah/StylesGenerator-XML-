...
function tagAlreadyExistsAlert() {
    return <p className="absolute left-[50%] top-[50%] bg-orange-400 rounded-lg p-2 flex gap-2 text-white"> <TriangleAlert color="white" /> {`you have already added the tag to your Theme`}</p>;
}