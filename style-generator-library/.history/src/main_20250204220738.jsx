...
function tagAlreadyExistsAlert() {
    return <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8/12 bg-orange-400 rounded-lg p-2 flex gap-2 text-white"> <TriangleAlert color="white" /> {`you have already added the tag to your Theme`}</div>;
}