...
export default function Main() {
    ...
    function EditFormHandler(property, value, arr = false, index = 0) {
        if (!arr) {
            let newElement = { ...selectedElement, [property]: value }; // Corrected: Ensure you spread the selectedElement
        } else {
            let newVal = selectedElement.[property]
            newVal[index] = value;
            let newElement = { ...selectedElement, [property]: newVal }; // Corrected: Ensure you spread the selectedElement
