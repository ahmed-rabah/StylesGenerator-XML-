...
export default function EditSide({ element, EditFormHandler }) {
    ...
    return (
        <div className="col-span-4 py-4 pl-3 border-gray-300 border-l-2 bg-[#F5F5F5] mt-2 rounded-lg text-xl  max-h-[80vh] overflow-scroll hidden-scrollbar">
            {
                element &&
                (<>
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <select onChange={(e) => { EditFormHandler("fontFamily", e.target.value); }} className="pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                            {
                                filteredOptions.map((option, index) => (
                                    <option
                                        ...
                                        onClick={() => {
                                            EditFormHandler("fontStyle", "option");
                                            setSelected(option);
                                            setSearch(option);
                                            setIsOpen(false);
                                        }}
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <select onChange={(e) => { EditFormHandler("fontStyle", e.target.value); }} className="pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                            {
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <select onChange={(e) => { EditFormHandler("fontWeight", e.target.value); }} className="pl-3 pr-1 py-1  text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                            {
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select onChange={(e) => { EditFormHandler("fontSize", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <select onChange={(e) => { EditFormHandler("textAlign", e.target.value); }} className="pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                            {
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select onChange={(e) => { EditFormHandler("width", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                                    ["px", "em", "rem", "%", "vw", "vh", "pc", "in"].map((option, index) => (
                                        <option
                                            key={index}
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select onChange={(e) => { EditFormHandler("padding", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                                    ["px", "em", "rem", "%", "vw", "vh", "pc", "in"].map((option, index) => (
                                        <option
                                            key={index}
