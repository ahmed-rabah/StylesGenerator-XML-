...
export default function EditSide({ element, EditFormHandler, elementId }) {
        ...
        <div className="col-span-4 py-4 pl-3 border-gray-300 border-l-2 bg-[#F5F5F5] mt-2 rounded-lg text-xl">
            {
                ...
                (<form>
                    ...
                    <div className="w-full my-1">
                        ...
                        <input id="class" type="text" value={element.class} onChange={(e) => { EditFormHandler(element.idEl, "class", e.target.value) }} className="pl-3 pr-3 py-1 border-2 text-base font-medium rounded-md w-[90%] bg-white " />
                    </div>
                    <div className="w-[100%] my-1 ">
                        <label htmlFor="id" className="font-rubik text-xl  md:block">Id :</label>
                        <input id="id" type="text" value={element.id} onChange={() => { }} className="pl-3 pr-1 py-1  border-2 text-base font-medium rounded-md bg-white  w-[90%] text-black" />
                    </div>
