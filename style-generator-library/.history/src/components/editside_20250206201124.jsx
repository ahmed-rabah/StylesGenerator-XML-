        ...
        <div className="col-span-4 py-4 pl-3 border-gray-300 border-l-2 bg-[#F5F5F5] mt-2 rounded-lg text-xl">
            {
                ...
                (<>
                    ...
                    <div className="w-[90%] my-1">
                        <label className="font-rubik text-2xl  md:block">Background Color:</label>
                        <div className="flex items-center justify-start gap-2 ">
                            <input
                                type="color"
                                value={color}
                    ...
                    <div className="w-[90%] my-1">
                        <label className="font-rubik text-2xl  md:block">Border Color:</label>
                        <div className="flex items-center justify-start gap-2 ">
                            <input
                                type="color"
                                value={color}
                    ...
                    <div className="relative w-[100%] my-1">
                        <label className="font-rubik text-2xl  md:block">Font Family:</label>
                    ...
                    <div className="w-[100%] my-1 ">
                        <label className="font-rubik text-2xl  md:block">Font Style :</label>
                    ...
                    <div className="w-[100%] my-1 ">
                        <label className="font-rubik text-2xl  md:block">Font Weight :</label>
                        <select className="pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                            {
                    ...
                    <div className="w-[100%] my-1 ">
                        <label className="font-rubik text-2xl  md:block">Font Size :</label>
                        <input type="text" value={element.id} onChange={() => { }} className="pl-3 pr-1 py-1  border-2 text-base font-medium rounded-md bg-white  w-[90%] text-black" />
                    </div>
                    <div className="w-[100%] my-1 ">
                        <label className="font-rubik text-2xl  md:block">Text Align :</label>
                        <select className="pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                            {
