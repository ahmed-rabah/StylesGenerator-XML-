        ...
        <div className="col-span-4 py-4 pl-3 border-gray-300 border-l-2 bg-[#F5F5F5] mt-2 rounded-lg text-xl">
            {
                ...
                (<>
                    ...
                    <div className="w-[100%] ">
                        ...
                        <input type="text" value={element.fontFamily} onChange={() => { }} className="pl-3 pr-1 py-1  border-2 text-base font-medium rounded-md bg-white  w-[90%] text-black" />
                    </div>
                    <div className="relative w-64">
                        ...
                        {/* Dropdown List */}
                        {isOpen && (
                            <ul className="absolute z-10 w-full bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
