        ...
        <div className="col-span-4 py-4 pl-3 border-gray-300 border-l-2 bg-[#F5F5F5] mt-2 rounded-lg text-xl">
            {
                ...
                (<form action="">
                    <div className="hidden">
                        <label htmlFor="idEl" className="font-rubik text-xl  md:block">idEl :</label>
                        <input type="text" disabled value={element.idEl} onChange={() => { }} className="pl-3 pr-3 py-1 border-2 text-base font-medium rounded-md w-[90%] bg-white " />
