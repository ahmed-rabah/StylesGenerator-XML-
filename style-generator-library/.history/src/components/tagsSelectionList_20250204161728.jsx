...
export default function DropdownMenu() {
    ...
    return (
        <div className="relative col-span-2 bg-white shadow-lg p-4 rounded-lg hidden md:block">
    ...
    return (
        <li key={category} >
            <button
                ...
                className={`flex items-center justify-between  rounded-sm px-4 py-2 ${btnBg}  border hover:bg-gray-100 cursor-pointer`}
            >
