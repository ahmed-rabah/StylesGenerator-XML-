...
export default function DropdownMenu() {
    ...
    return (
        <div className="relative col-span-2 bg-white shadow-lg p-4 rounded-lg hidden md:block border-r border-cyan-700">
                    ...
                    <ul className="pt-2">
                        {
                            categoryItems.map((item, index) => (
                                <li key={index} className="px-4 py-2 hover:bg-gray-100 cursor-pointer border-b text-center">
                                    {item}
                                </li>
