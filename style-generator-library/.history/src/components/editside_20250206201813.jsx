                ...
                (<>
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="flex">
                            ...
                            <input type="number" value={element.fontSize[0]} onChange={() => { }} className="pl-3 pr-1 py-1  border-2 text-base font-medium rounded-md bg-white  w-[90%] text-black" />
                            <select className="pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1  overflow-auto">
                                {
