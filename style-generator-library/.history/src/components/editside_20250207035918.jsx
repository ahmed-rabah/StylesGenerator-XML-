                ...
                (<>
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select value={element.fontSize} onChange={(e) => { EditFormHandler("fontSize", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select value={element.width} onChange={(e) => { EditFormHandler("width", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                                    ["px", "em", "rem", "%", "vw", "vh", "pc", "in"].map((option, index) => (
                                        <option
                                            key={index}
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select value={element.height} onChange={(e) => { EditFormHandler("fontSize", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                                    ["px", "em", "rem", "%", "vw", "vh", "pc", "in"].map((option, index) => (
                                        <option
                                            key={index}
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select value={element.margin} onChange={(e) => { EditFormHandler("fontSize", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                                    ["px", "em", "rem", "%", "vw", "vh", "pc", "in"].map((option, index) => (
                                        <option
                                            key={index}
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <select value={element.padding} onChange={(e) => { EditFormHandler("padding", e.target.value, true, 1); }} className="col-span-8 pl-3 pr-1 py-1   text-base font-medium   text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
                                    ["px", "em", "rem", "%", "vw", "vh", "pc", "in"].map((option, index) => (
                                        <option
                                            key={index}
