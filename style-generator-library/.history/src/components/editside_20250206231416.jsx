                ...
                (<>
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <input type="number" value={element.fontSize[0]} onChange={(e) => { EditFormHandler("fontWeight", e.target.value, true, 0); }} className="col-span-4 pl-3 pr-1 py-1  border-2 text-base font-medium rounded-md bg-white text-black" />
