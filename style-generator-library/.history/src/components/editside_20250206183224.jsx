                ...
                (<>
                    <div className="w-full flex items-center justify-start gap-x-2 ">
                        ...
                        <div className="relative ">
                            ...
                            <input type="text" disabled value={element.tag} className="pl-10 pr-3 py-2 border-2 rounded-md w-fit" />
                        </div>
                    </div>
                    <div className="w-full flex items-center justify-start gap-x-2">
                        <label className="font-rubik ">Class :</label>
                        <input type="text" value={element.class} onChange={() => { }} className="pl-10 pr-3 py-2 border-2 rounded-md bg-white " />
                    </div>
                    <div className="w-full flex items-center justify-start gap-x-2">
                        <label className="font-rubik ">id :</label>
                        <input type="text" value={element.id} onChange={() => { }} className="pl-10 pr-1 py-1  border-2 rounded-md bg-white text-black" />
                    </div>
                    <div className="w-full flex items-center justify-start gap-x-2">
                        <label className="font-rubik ">id :</label>
                        <input type="text" value={element.id} onChange={() => { }} className="pl-10 pr-1 py-1  border-2 rounded-md bg-white text-black" />
