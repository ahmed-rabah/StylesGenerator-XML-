    ...
    return (
        <li key={category} >
            <button
                ...
                {
                    open ? (className = "flex items-center justify-between w-48 rounded-sm px-4 py-2 border hover:bg-gray-100 cursor-pointer")

                }
                className="flex items-center justify-between w-48 rounded-sm px-4 py-2 border hover:bg-gray-100 cursor-pointer"
            >
