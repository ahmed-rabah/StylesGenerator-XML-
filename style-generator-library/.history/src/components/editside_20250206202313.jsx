                ...
                (<>
                    ...
                    <div className="w-[100%] my-1 ">
                        ...
                        <div className="grid-cols-12 gap-2">
                            ...
                            <input type="number" value={element.fontSize[0]} onChange={() => { }} className="col-span-4 pl-3 pr-1 py-1  border-2 text-base font-medium rounded-md bg-white  w-[90%] text-black" />
                            <select className="col-span-8 pl-3 pr-1 py-1   text-base font-medium  w-[90%] text-black bg-white border rounded-md shadow-md mt-1 max-h-40 overflow-auto">
                                {
