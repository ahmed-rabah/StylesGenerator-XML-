        ...
        <div className="col-span-4 py-4 pl-3 border-gray-300 border-l-2 bg-[#F5F5F5] mt-2 rounded-lg text-xl">
            {
                ...
                (<form>
                    ...
                    <div className="w-full my-1">
                        ...
                        <input id="class" type="text" value={element.class} onChange={(e) => { EditFormHandler(elementId, "class", e.target.value) }} className="pl-3 pr-3 py-1 border-2 text-base font-medium rounded-md w-[90%] bg-white " />
                    </div>
