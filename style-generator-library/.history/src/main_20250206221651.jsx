...
export default function Main() {
    ...
    function EditClassHandler(value) {
        let newElement = { selectedElement, class: value }
        setTheme((oldTheme) => {
            let newTheme = oldTheme.map(element => {
                (selectedElementId == element.idEl) ? newElement : element;
            })
            return newTheme;
        })
    }
    ...
    return (
        <main className="grid grid-cols-12 gap-4 min-h-screen" >
            ...
            <EditSide element={selectedElement} EditClassHandler={EditClassHandler} />
