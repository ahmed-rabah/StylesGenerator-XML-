...
export default function Main() {
    ...
    function EditFormHandler(property, value) {

        setTheme((oldTheme) => {
            let newTheme = oldTheme.map(element => {


                (selectedElementId == element.idEl) ? element : element;
            })
            return newTheme;
        })
    }
    ...
    console.log(theme);
    return (
        <main main className="grid grid-cols-12 gap-4 min-h-screen" >
            ...
            <EditSide elementId={selectedElementId} element={selectedElement} EditFormHandler={EditFormHandler} />
